...
int8_t cursor = -1;
const char* cursorPositions[] = {
    "13;30", "13;60", "13;90", "18;30", "18;60", "18;90", "23;30", "23;60",
    "23;90", "28;30", "28;60", "28;90", "40;16", "40;38", "40;67", "40;89"};
...
/* void getData4DAC(uint16_t* dac_buff) { */
/*   float y, t = 0; */
/*  */
/*   for (uint16_t n = 0; n < (DAC_BUFF_SIZE); n++) { */
/*     y = (sinParams[1] / 100) * sinf(2 * PI * sinParams[0] * t) + 1.5 + */
/*         (sinParams[3] / 100) * sinf(2 * PI * sinParams[2] * t); */
